    ...
    <div id="content">
        <div class="inner">
            ...
            <article class="box post post-excerpt">
                ...
                <a href="#" class="image featured"><img src="<?php echo e(asset('images/tournamentpic.png')); ?>" alt="" /></a>
                <p>
            ...
            <article class="box post post-excerpt">
                ...
                <a href="#" class="image featured"><img src="<?php echo e(asset('images/owv2024image.jpg')); ?>" alt="" /></a>
                <p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/pages/homepage.blade.php ENDPATH**/ ?>